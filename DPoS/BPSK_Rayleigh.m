...
OFDM_COUNT_BPSK_Rayleigh(ii)=count1/(count1+count2); 
% OFDM_COUNT_BPSK_AWGN(ii)=count1/(count1+count2); 
BIT_ERROR_BPSK_Rayleigh(ii)=1-(errorbitcount/totalbits); 

end
save('uncoded_OFDM_BPSK_Rayleigh.mat','OFDM_COUNT_BPSK_Rayleigh','BIT_ERROR_BPSK_Rayleigh','EbN0dB');
