...
OFDM_COUNT_QPSK_Rayleigh(ii)=count1/(count1+count2); 
% OFDM_COUNT_BPSK_AWGN(ii)=count1/(count1+count2); 
BIT_ERROR_QPSK_Rayleigh(ii)=1-(errorbitcount/totalbits); 

end
save('uncoded_OFDM_QPSK_Rayleigh.mat','OFDM_COUNT_QPSK_Rayleigh','BIT_ERROR_QPSK_Rayleigh','EbN0dB');
