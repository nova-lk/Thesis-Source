...
OFDM_COUNT_QPSK_Rician(ii)=count1/(count1+count2); 
% OFDM_COUNT_BPSK_AWGN(ii)=count1/(count1+count2); 
BIT_ERROR_QPSK_Rician(ii)=1-(errorbitcount/totalbits); 

end
save('uncoded_OFDM_QPSK_Rician.mat','OFDM_COUNT_QPSK_Rician','BIT_ERROR_QPSK_Rician','EbN0dB');
